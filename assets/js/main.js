...
(function ($) {
  ...
  if ($(".tw-main-menu-desktop-copy").length && $(".tw-main-menu-mobile").length) {
    let navContent = document.querySelector(".tw-main-menu-desktop-copy").outerHTML;
  ...
  $(document).ready(function () {
    ...
    // Smooth scroll and offcanvas auto-close on navigation click
